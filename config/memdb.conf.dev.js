...
const mongo_password = 'root!23ROOT';
const mongo_database = 'fishHunter';

const mongo_url = mongo_password ?
    `mongodb://${mongo_username}:${mongo_password}@${host}:${mongo_port}/${mongo_database}?authSource=admin` :
    `mongodb://${host}:${mongo_port}/${mongo_database}`

// const host = '52.195.241.2';
// const host
// = 'fish.aspectgaming.dev';
...
//        url: 'mongodb://root:admin@localhost/JiaYuGame?authSource=admin', // mongodb connect string
    ...
    persistentDelay : 100, // 600 * 1000, // number in ms, default 10 min. 0 indicates never
